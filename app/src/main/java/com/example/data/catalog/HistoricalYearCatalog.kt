...
/**
 * Authoritative Historical Exam Catalog for AIPMT & NEET UG.
 *
 * Target Coverage Window: 2006–2025 (20 Exam Years).
 *
 * This catalog represents coverage metadata only. It NEVER generates or fabricates questions.
...
object HistoricalYearCatalog {
    ...
    const val START_YEAR = 2006
    const val END_YEAR = 2025
    const val TOTAL_YEARS = 20

    /**
     * Authoritative 20-year historical coverage target window from 2006 to 2025.
     * Expected question counts reflect the official paper structures:
     * - AIPMT 2006-2012: 200 Questions (50 Physics, 50 Chemistry, 100 Biology)
    ...
    val ALL_YEARS: List<HistoricalExamYearInfo> = listOf(
        ...
        // TRANSITION & NEET ERA
        HistoricalExamYearInfo("NEET", 2013, "MAIN", 180, 45, 45, 90, "NEET (MCI/CBSE)", "Inaugural National Eligibility cum Entrance Test"),
        ...
        HistoricalExamYearInfo("NEET", 2016, "PHASE_1", 180, 45, 45, 90, "NEET (CBSE)", "NEET Phase 1 & Phase 2 combined era"),
        HistoricalExamYearInfo("NEET", 2017, "MAIN", 180, 45, 45, 90, "NEET (CBSE)", "Centralized single national test"),
        HistoricalExamYearInfo("NEET", 2018, "MAIN", 180, 45, 45, 90, "NEET (CBSE)", "Final exam conducted by CBSE"),
        HistoricalExamYearInfo("NEET", 2019, "MAIN", 180, 45, 45, 90, "NEET (NTA)", "First edition conducted by National Testing Agency"),
        HistoricalExamYearInfo("NEET", 2020, "MAIN", 180, 45, 45, 90, "NEET (NTA)", "Conducted during COVID-19 pandemic"),
        HistoricalExamYearInfo("NEET", 2021, "MAIN", 200, 50, 50, 100, "NEET (NTA)", "Introduction of Section A & Section B choice format"),
        HistoricalExamYearInfo("NEET", 2022, "MAIN", 200, 50, 50, 100, "NEET (NTA)", "Standardized 200-minute time allowance"),
        HistoricalExamYearInfo("NEET", 2023, "MAIN", 200, 50, 50, 100, "NEET (NTA)", "National & Manipur special session"),
        HistoricalExamYearInfo("NEET", 2024, "MAIN", 200, 50, 50, 100, "NEET (NTA)", "Conducted across 571 cities"),
        HistoricalExamYearInfo("NEET", 2025, "MAIN", 200, 50, 50, 100, "NEET (NTA)", "Current examination cycle")
    )
    ...
    fun getNeetYears(): List<HistoricalExamYearInfo> =
        ALL_YEARS.filter { it.exam == "NEET" || it.exam == "NEET_UG" }

...
data class NeetQuestion(
    ...
    val paperSession: String? = null,
    val isOfficialPYQ: Boolean = false,
    val syllabusStatus: String = "CURRENT",
...
// Sample Original Practice Questions (Non-Official Demo Questions)
val sampleNeetQuestions = listOf(
    NeetQuestion(
        ...
        difficulty = "EASY",
        isOfficialPYQ = false,
        sourceVerificationStatus = "SAMPLE"
    ),
    NeetQuestion(
        id = "q_phy_2",
        subjectName = "Physics",
